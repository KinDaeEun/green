...
<table class="table table-bordered">
	<tr><th>아이디 <i class="bi bi-file-earmark-person icofont-2x"></i></th>
		<td class="bg-info">${member.id }</td></tr>
	<tr><th>암호  <i class="bi bi-file-lock2 icofont-2x"></i></th><td>
		<input type="password" name="password"
	 	required="required" class="form-control"></td></tr>
	 <tr><th>암호확인  <i class="bi bi-file-lock2 icofont-2x"></i></th><td>
		<input type="password" name="password2"
	 	required="required" class="form-control"></td></tr>
	 <tr><th>이름   <i class="bi bi-person-vcard icofont-2x"></i></th><td>
		<input type="text" name="name" value="${member.name }"
	 	required="required" class="form-control"></td></tr>
	 <tr><th>이메일  <i class="bi bi-envelope icofont-2x"></i></th><td>
		<input type="email" name="email" value="${member.email }"
	 	required="required" class="form-control"></td></tr>
	<tr><th>사진<i class="bi bi-file-earmark-person icofont-2x"></i></th>
		<td><input type="file" name="file" class="form-control">${member.fileName }</td></tr>
	<!-- drag & drop -->
	<tr><th>사진  <i class="bi bi-file-earmark-person icofont-2x"></i></th> 
		<td><div id="drop"><div id="thumbnails">
		<img alt="" src="resources/upload/${member.fileName }" 
			width="200" class="rounded img-thumbnail"> </div></div></td></tr>
	<tr><td colspan="2" align="center"><input type="submit" value="회원정보 수정" 
